...
def extract_chapters(html):
    ...
    book_title = soup.find('div', style="line-height: 35px; height: 35px; font-size: 26px; color: #333; margin-bottom: 10px; font-weight: bold; text-align: center;").text.strip()
    chapters = []
...
async def main():
    ...
    book_title, chapters = extract_chapters(menu_html)
